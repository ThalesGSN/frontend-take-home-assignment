...
describe('House saving plan', () => {
  ...
  describe('Saving goals results', () => {
    ...
    it('should show results for $30,000 dollars and 50 months from now', () => {
      cy.get(totalAmountInput).clear().type('30000');
      cy.get(nextButton).click().click();
      cy.get(savingResult)
        .should('have.text', '$600');
      cy.get(savingDetails)
        .should('have.text', 'You’re planning 50 monthly deposits to reach your $30,000 goal by December 2024.');
    });
